...
const ListOfProducts = () => {
	...
	return (
		<View>
			<Text style={styles.headingText}>List of Products</Text>
			<FlatList
...
const styles = StyleSheet.create({
	...
	imageStyle: {
		borderRadius: 10,
		marginTop: 4,
		boxShadow: "10px 7px 5px rgb(109, 120, 131) ",
	},
	textStyle: {
		fontStyle: "italic",
		fontSize: 20,
	...
	ratingStyle: { fontSize: 16, color: "#888" },
	priceStyle: { fontSize: 16, color: "#000", marginBottom: 4 },
});
